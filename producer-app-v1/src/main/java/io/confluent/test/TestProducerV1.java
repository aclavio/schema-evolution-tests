...
public class TestProducerV1 implements Closeable {
    private static final Logger logger = LoggerFactory.getLogger(TestProducerV1.class);
    ...
    public TestProducerV1(Properties config) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try(TestProducerV1 testProducer = new TestProducerV1(cfg)) {
